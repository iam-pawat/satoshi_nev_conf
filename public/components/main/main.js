...
export class Main extends React.Component {
  ...
  componentDidMount() {
    ...
    */
    ...
    httpClient.get('../api/satoshi_nev_conf/example').then((resp) => {
        ...
        <EuiPageBody>
          <EuiPageHeader>
            <EuiTitle size="l">
              <h1>
                <FormattedMessage
                  id="satoshiNevConf.helloWorldText"
          ...
          <EuiPageContent>
            <EuiPageContentHeader>
              <EuiTitle>
                <h2>
                  <FormattedMessage
                    id="satoshiNevConf.congratulationsTitle"
            ...
            <EuiPageContentBody>
              <EuiText>
                <h3>
                  <FormattedMessage
                    id="satoshiNevConf.congratulationsText"
                    defaultMessage="You have successfully created your first Kibana Plugin!"
                  />
                </h3>
                <p>
                  <FormattedMessage
                    id="satoshiNevConf.serverTimeText"
